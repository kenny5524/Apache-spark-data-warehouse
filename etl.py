...
def create_spark_session():
    ...
    * spark -- An Apache Spark session.
    """
    spark =spark = SparkSession.builder.appName("curt").getOrCreate() 
    spark._jsc.hadoopConfiguration().set("fs.s3a.access.key", "AKIAQZ6MRHNVQALAFJWU")
    spark._jsc.hadoopConfiguration().set("fs.s3a.secret.key", "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")
